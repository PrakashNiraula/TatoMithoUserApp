...
class NightPopularRestaurantView extends StatelessWidget {
  final bool isPopular;
  NightPopularRestaurantView({@required this.isPopular});
      ...
      return (_restaurantList != null && _restaurantList.length == 0) ? SizedBox() : Column(
        children: [
          Padding(
            ...
            child: TitleWidget(
              title: isPopular ? 'Night Delicacy'.tr : '${'new_on'.tr} ${AppConstants.APP_NAME}',

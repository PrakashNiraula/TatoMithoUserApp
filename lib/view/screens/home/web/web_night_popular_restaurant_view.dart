...
class NightWebPopularRestaurantView extends StatelessWidget {
  final bool isPopular;
  NightWebPopularRestaurantView({@required this.isPopular});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<RestaurantController>(builder: (restController) {
      List<Restaurant> _restaurantList = isPopular ? restController.nightRestaurantList : restController.nightRestaurantList;

      return Column(
        children: [
          Padding(
            padding: EdgeInsets.fromLTRB(10, 15, 10, 10),
            child: TitleWidget(title: isPopular ? 'Night Delicacy'.tr : '${'new_on'.tr} ${AppConstants.APP_NAME}'),
          ),
